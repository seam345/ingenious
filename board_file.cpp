...
vector<int> board::getLeft(int ring, int section, int position)
{
    if (ring == 0)
    {
...
vector<int> board::getTopRight(int ring, int section, int position)
{
    if (ring == 0)
    {
...
vector<int> board::getTopLeft(int ring, int section, int position)
{
    if (ring == 0)
    {
...
vector<int> board::getRight(int ring, int section, int position)
{
    if (ring == 0)
    {
...
vector<int> board::getRightBottom(int ring, int section, int position)
{
    if (ring == 0)
    {
...
vector<int> board::getLeftBottom(int ring, int section, int position)
{
    if (ring == 0)
    {
